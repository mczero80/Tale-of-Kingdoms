...
public class EntityReficulMage extends EntityNPC {
   ...
   protected void func_70785_a(Entity entity, float f) {
      if(f < 6.0F) {
         if(this.field_70724_aR == 0) {
            this.func_71038_i();
            this.field_70170_p.setBlock((int)entity.posX, (int)entity.posY - 1, (int)entity.posZ, 51);
            this.field_70724_aR = 40;

            for(int i = 0; i < 8; ++i) {
               this.field_70170_p.spawnParticle("portal", entity.posX - 1.0D + (this.field_70146_Z.nextDouble() - 0.5D) * (double)this.field_70130_N, entity.posY - 1.0D + this.field_70146_Z.nextDouble() * (double)this.field_70131_O - 0.25D, entity.posZ + 1.0D + (this.field_70146_Z.nextDouble() - 0.5D) * (double)this.field_70130_N, (this.field_70146_Z.nextDouble() - 0.5D) * 2.0D, -this.field_70146_Z.nextDouble(), (this.field_70146_Z.nextDouble() - 0.5D) * 2.0D);
            }
   ...
   protected void func_70626_be() {
      ...
      if(this.player != null) {
         if(this.player.func_70068_e(this) <= 220.0D && this.field_70170_p.difficultySetting != 0 && this.field_70170_p.difficultySetting != 0) {
